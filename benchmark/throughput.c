...
#define MAX_SAMPLES 10000000 // Large buffer for high throughput
...
int main(int argc, char **argv) {
    ...
    printf("Starting THROUGHPUT test (Uncapped): %d threads, %d seconds...\n", NUM_THREADS, DURATION_SEC);
